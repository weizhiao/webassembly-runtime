...
if (RUNTIME_BUILD_DISPATCH EQUAL 1)
    add_definitions (-DWASM_ENABLE_DISPATCH=1)
    message ("     interpreter dispatch enabled")
else ()
    add_definitions (-DWASM_ENABLE_DISPATCH=0)
    message ("     interpreter dispatch disabled")
endif ()
