...
bool wasm_jit_compile_op_i32_compare(JITCompContext *comp_ctx, JITFuncContext *func_ctx,
                                     IntCond cond)
{
    LLVMIntPredicate op;
    ...
    {
        wasm_jit_set_last_error("invalid WASM condition opcode");
        return false;
    }
    ...
    {
        wasm_jit_set_last_error("llvm build compare failed.");
        return false;
    }
...
bool wasm_jit_compile_op_i64_compare(JITCompContext *comp_ctx, JITFuncContext *func_ctx,
                                     IntCond cond)
{
    LLVMIntPredicate op;
    LLVMValueRef lhs, rhs, res;
...
bool wasm_jit_compile_op_f32_compare(JITCompContext *comp_ctx, JITFuncContext *func_ctx,
                                     FloatCond cond)
{
...
bool wasm_jit_compile_op_f64_compare(JITCompContext *comp_ctx, JITFuncContext *func_ctx,
                                     FloatCond cond)
{
    LLVMRealPredicate op;
    LLVMValueRef lhs, rhs, res;
