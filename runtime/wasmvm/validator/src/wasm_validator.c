...
static bool
wasm_loader_pop_frame_csp(WASMModule *module, WASMLoaderContext *ctx)
{
    BranchBlock *frame_csp;
    ...
    while (p < p_end)
    {
        ...
        case WASM_OP_LOOP:
        {
            ...
            if (opcode == WASM_OP_IF &&
                !wasm_emit_branch_table(loader_ctx, WASM_OP_IF, 0))
                goto fail;
        ...
        case WASM_OP_END:
        {
            ...
            if (!wasm_loader_pop_frame_csp(module, loader_ctx))
                goto fail;
